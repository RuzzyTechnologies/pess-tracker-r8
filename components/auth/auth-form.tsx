...
export function AuthForm({
  ...
  const [signupState, signupAction, signupPending] = useActionState(onSignup ?? (async () => initialState), initialState)
  ...
  return (
    ...
    >
      <Card className="backdrop-blur supports-[backdrop-filter]:bg-white/75 w-full max-w-md border border-sky-100/70 shadow-sm">
        ...
        <CardContent>
          <form action={action} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="pl-9 border-sky-100 focus-visible:ring-sky-400/40"
                  />
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="pr-10 pl-9 border-sky-100 focus-visible:ring-sky-400/40"
                />
            ...
            {state?.error && (
              <div
                role="alert"
                className="rounded-md border border-red-200 bg-red-50/70 px-3 py-2 text-sm text-red-700"
              >
                {state.error}
              </div>
            )}
            ...
            <div className="text-center text-sm text-slate-600">
              {isSignup ? (
                ...
                <>
                  New here?{" "}
                  <Link className="font-medium text-sky-700 underline-offset-4 hover:underline" href="/signup">
                    Create an account
                  </Link>
                </>
              )}
